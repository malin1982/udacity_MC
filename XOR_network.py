...
def EvalNetwork(inputValues, Network):
    ...
    # YOUR CODE HERE
    strength = Network[1].activate([inputValues[0],\
                        Network[0].activate([inputValues[0],inputValues[1]]),\
                        inputValues[1]])
    OutputValue = int (strength > Network[1].threshold)
